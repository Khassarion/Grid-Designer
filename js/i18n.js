...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      folderWatchDesc: "폴더마다 새 이미지가 생기면 지정한 레이아웃에 자동으로 추가합니다. Chrome/Edge 등에서 동작하며, 이 탭이 열려 있는 동안만 감시합니다.",
      folderWatchEnable: "자동 추가 사용",
      folderWatchRules: "감시 규칙",
      folderWatchAddRuleTitle: "규칙 추가",
      folderWatchFolder: "감시 폴더",
      folderWatchPick: "폴더 선택",
      folderWatchClear: "해제",
      folderWatchNoFolder: "(미선택)",
      folderWatchTarget: "추가할 레이아웃",
      folderWatchRemoveRule: "규칙 제거",
      folderWatchCancel: "취소",
      folderWatchSave: "저장",
      folderWatchUnsupported: "이 브라우저는 폴더 감시를 지원하지 않습니다. Chrome 또는 Edge를 사용하세요.",
      folderWatchNeedFolder: "감시할 폴더가 있는 규칙을 하나 이상 추가하세요.",
      ...
      folderWatchRelink: "감시 폴더 권한이 없습니다. 자동 설정에서 폴더를 다시 선택하세요.",
      folderWatchEmpty: "규칙이 없습니다. + 로 추가하세요.",
      whatsNewTitle: "업데이트 안내",
      whatsNewLead: "v{version}으로 업데이트되었습니다. 새로 추가·개선된 내용입니다.",
      whatsNewLeadFrom: "이전에 확인한 버전: v{from} → 현재 v{version}",
      whatsNewOk: "확인",
      whatsNewLightboxClose: "닫기",
      whatsNewImageZoom: "클릭하면 원본 크기로 보기",
      remove: "제거",
      removeTitle: "선택 항목 제거",
      clearAll: "전체",
      clearAllTitle: "선택 대상의 자식 전체 제거",
      treeViewMenu: "보기 ▾",
      treeViewMenuTitle: "계층 구조 표시 옵션",
      showTreeThumbs: "썸네일 표시",
      collapseAllLayouts: "모두 접기",
      expandAllLayouts: "모두 펼치기",
      ...
      axisVertical: "수직",
      childAlign: "자식 정렬",
      childAlignHint: "셀 그룹이 레이아웃 안 어디에 붙는지",
      constraint: "제약",
      constraintType: "유형",
      constraintAuto: "자동",
    ...
    en: {
      ...
      projectGroupTitle: "Hierarchy file",
      ...
      folderWatchDesc: "When new images appear in a watched folder, they are added to that rule’s layout. Works in Chrome/Edge and only while this tab is open.",
      folderWatchEnable: "Enable auto-add",
      folderWatchRules: "Watch rules",
      folderWatchAddRuleTitle: "Add rule",
      ...
      folderWatchRemoveRule: "Remove rule",
      ...
      folderWatchNeedFolder: "Add at least one rule with a watch folder.",
      ...
      folderWatchRelink: "Watch-folder access is missing. Re-select folders in Auto settings.",
      folderWatchEmpty: "No rules yet. Use + to add one.",
      whatsNewTitle: "What's new",
      whatsNewLead: "Updated to v{version}. Here's what changed.",
      whatsNewLeadFrom: "Last seen: v{from} → now v{version}",
      whatsNewOk: "Got it",
      whatsNewLightboxClose: "Close",
      whatsNewImageZoom: "Click to view at original size",
      remove: "Remove",
      removeTitle: "Remove selection",
      clearAll: "Clear",
      clearAllTitle: "Remove all children of the selection",
      treeViewMenu: "View ▾",
      treeViewMenuTitle: "Hierarchy display options",
      showTreeThumbs: "Show thumbnails",
      collapseAllLayouts: "Collapse all",
      expandAllLayouts: "Expand all",
      ...
      childAlignHint: "Where the cell group sits inside the layout",
      ...
      bgColor: "Color",
      bgAlpha: "Opacity",
      bgAlphaHint: "0 = fully transparent · 100 = opaque",
      preview: "Preview",
      ...
      expand: "Expand",
      collapse: "Collapse",
      layoutHide: "Hide layout",
      layoutShow: "Show layout",
